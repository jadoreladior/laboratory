...
router.get('/bookings', async (req, res, next) => {
  try {
    ...
    const header = ['ID', 'Клиент', 'Telegram', 'Username', 'Услуга', 'Дата', 'Время', 'Длит.(ч)', 'Сумма', 'Предоплата', 'Статус', 'Создано']
...
router.get('/financial', async (req, res, next) => {
  try {
    ...
    const header = ['Дата', 'Время', 'Услуга', 'Клиент', 'Сумма (₽)', 'Предоплата (₽)', 'Статус']
